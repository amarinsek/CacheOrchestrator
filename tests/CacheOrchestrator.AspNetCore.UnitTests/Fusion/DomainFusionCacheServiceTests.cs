...
public class DomainFusionCacheServiceTests
{
    ...
    [Fact]
    public async Task GetOrSetAsync_WhenDataCacheRespectAuthBypass_AndAuthenticated_CallsFactoryUncached()
    {
        var http = new DefaultHttpContext();
    ...
    [Fact]
    public async Task GetOrSetAsync_WhenDataCacheRespectAuthBypassFalse_StillCachesUnderAuthorization()
    {
        var http = new DefaultHttpContext();
    ...
    // =========================
    // Normal path ï¿½ key generation & tags
    // =========================
        ...
        TimeSpan? failSafe = null)
    {
        ...
        return new()
        {
            ...
            DataCacheRespectNoStore = respectNoStore,
