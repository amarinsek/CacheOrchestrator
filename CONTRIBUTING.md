...
- [.NET SDK](https://dotnet.microsoft.com/download) that supports **net8.0** and **net10.0** (SDK 10.x is fine for multi-target builds). Libraries, **Admin App**, and tests multi-target both; samples are net10-only.
...
```bash
# Unit tests — multi-target net8.0 + net10.0 (matches published library TFMs)
