  ...
  paintPage(`
    <div class="card">
      ...
      <p class="muted">
        ...
        Extra packs: <code>CacheAdmin:Hints:RuleFiles</code> (e.g. <code>hints/*.json</code>).
        Disable codes here (saved to <code>hints/disabled.local.json</code>) or via
        <code>DisabledCodes</code> in config. See <code>hints/README.md</code>.
      </p>
      <p class="muted small">
