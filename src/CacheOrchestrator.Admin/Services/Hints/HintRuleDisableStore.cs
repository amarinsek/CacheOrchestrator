...
namespace CacheOrchestrator.Admin.App.Services.Hints;

/// <summary>
/// Merges <c>CacheAdmin:Hints:DisabledCodes</c> with a local JSON override file
...
public sealed class HintRuleDisableStore : IHintRuleDisableStore
{
    ...
    private readonly IOptionsMonitor<CacheAdminOptions> _options;
    ...
    public HintRuleDisableStore(IOptionsMonitor<CacheAdminOptions> options, IHostEnvironment env)
    {
