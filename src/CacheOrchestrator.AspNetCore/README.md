...
ASP.NET Core host integration for CacheOrchestrator: Output Cache policies, client Cache-Control, Admin API, vary materialization, and HTTP-aware domain data-cache helpers (`IDomainDataCache`).
