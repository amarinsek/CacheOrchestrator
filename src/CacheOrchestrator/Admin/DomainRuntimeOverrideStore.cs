...
internal sealed class DomainRuntimeOverrideStore : IDomainRuntimeOverrideStore
{
    ...
    internal static DomainRuntimeOverride Merge(DomainRuntimeOverride existing, DomainSettingsPatch patch, int stamp) =>
        new()
        {
            ...
            FusionCacheHardTtl = patch.FusionCacheHardTtl ?? existing.FusionCacheHardTtl,
            FusionCacheFailSafe = patch.FusionCacheFailSafe ?? existing.FusionCacheFailSafe,
            FusionCacheEagerRefreshRatio = patch.FusionCacheEagerRefreshRatio ?? existing.FusionCacheEagerRefreshRatio,
            FusionCacheJitter = patch.FusionCacheJitter ?? existing.FusionCacheJitter,
            FusionCacheFactorySoftTimeout = patch.FusionCacheFactorySoftTimeout ?? existing.FusionCacheFactorySoftTimeout,
            FusionCacheFactoryHardTimeout = patch.FusionCacheFactoryHardTimeout ?? existing.FusionCacheFactoryHardTimeout,
    ...
    private static DomainRuntimeOverride WithVersion(DomainRuntimeOverride existing, string version, int stamp) =>
        new()
        {
            ...
            FusionCacheHardTtl = existing.FusionCacheHardTtl,
            FusionCacheFailSafe = existing.FusionCacheFailSafe,
            FusionCacheEagerRefreshRatio = existing.FusionCacheEagerRefreshRatio,
            FusionCacheJitter = existing.FusionCacheJitter,
            FusionCacheFactorySoftTimeout = existing.FusionCacheFactorySoftTimeout,
            FusionCacheFactoryHardTimeout = existing.FusionCacheFactoryHardTimeout,
